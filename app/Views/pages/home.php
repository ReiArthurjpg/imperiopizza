    ...
    <?php require_once __DIR__ . '/equipe.php'; ?>
    <?php require_once __DIR__ . '/cozinha.php'; ?>
    <?php require_once __DIR__ . '/estoque.php'; ?>
    <?php require_once __DIR__ . '/pdv.php'; ?>
    <?php require_once __DIR__ . '/relatorios.php'; ?>
